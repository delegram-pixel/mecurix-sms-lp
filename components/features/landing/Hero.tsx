...
export default function Hero() {
  return (
    <section className="bg-gradient-to-b from-black from-10% via-black via-50% to-white to-80% px-8 pt-32 duration-200 md:px-16 md:pt-48 lg:px-32">
      <h1
        data-testid="hero"
      ...
      <Link
        href="/sign-up"
        className="rounded-lg bg-white/90 px-8 py-3 font-semibold text-black duration-200 hover:bg-white"
      >
        Get Started
      </Link>
      <Image
